...
data_state <- read_excel("STA202.xlsx", sheet = "State Information")
data_14 <- read_excel("STA202.xlsx", 
                      sheet = "14-16")
data_17 <- read_excel("STA202.xlsx", 
                      sheet = "17-18")
...
x = c(floor(sum(south_all_14$Sample_Youths * south_all_14$Arithmetic / 100)),
      floor(sum(north_all_14$Sample_Youths * north_all_14$Arithmetic / 100)))
